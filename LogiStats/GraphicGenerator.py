...
class GraphicGenerator:
    ...
    def scatterplot(self):
        ...
        columns_scatter_x = st.multiselect('Columnas para el eje X:', self.columns, default=None, key='x_dispersao')
        columns_scatter_y = st.multiselect('Columnas para el eje Y', self.columns, default=None, key='y_dispersao')
    ...
    def correlationPlot(self):
        ...
        with self._lock:
            ...
            ax.set_title('Mapa de calor de correlaciones de variables')
            st.pyplot(fig)
    ...
    def logisticRegressionPlot(self):
        st.markdown('### Gráficos de regresión logística')
        columns_regression_x = st.multiselect('Columnas para el eje X: ', self.columns, default=None, key='x_reg_log')
        columns_regression_y = st.multiselect('Columnas para el eje Y: ', self.binary_columns, default=None, key='y_reg_log')
